...
if TRAIN:
    try:
        ...
        for epoch in range(1, nb_epoch + 1):
            ...
            sys.stdout.flush()
            scores = model.fit(X_train, Y_train, batch_size=batch_size, epochs=1, verbose=1, validation_data=(X_test, Y_test))
        ...
        # Save time elapsed
        with open(model_path + model_name + "_time_elapsed.txt", 'w') as f:
...
if TEST:
    ...
    with open(test_songs_list, 'r') as f:
